...
TEST(SortedTupleQualifiers, GetByIndex_Lvalue) {
  Of<SizeofLess>::Tuple<double, char, int> t(1.0, 'a', 10);
...
TEST(SortedTupleQualifiers, GetByIndex_ConstLvalue) {
  const Of<SizeofLess>::Tuple<double, char, int> t(1.0, 'a', 10);
  decltype(auto) v = t.template Get<0>();
...
TEST(SortedTupleQualifiers, GetByIndex_VolatileLvalue) {
  volatile Of<SizeofLess>::Tuple<double, char, int> t(1.0, 'a', 10);
...
TEST(SortedTupleQualifiers, GetByIndex_ConstVolatileLvalue) {
  const volatile Of<SizeofLess>::Tuple<double, char, int> t(1.0, 'a', 10);
  decltype(auto) v = t.template Get<1>();
...
TEST_F(SortedTupleMoveTest, ConstructFromRvalues) {
  ...
  Of<SizeofLess>::Tuple<TrackedLarge, TrackedSmall> t(std::move(large),
                                                      std::move(small));
...
TEST_F(SortedTupleMoveTest, ConstructFromLvaluesCopies) {
  ...
  Of<SizeofLess>::Tuple<TrackedLarge, TrackedSmall> t(large, small);
...
TEST_F(SortedTupleMoveTest, CopyConstructCopies) {
  Of<SizeofLess>::Tuple<TrackedLarge, TrackedSmall> t1(TrackedLarge(1.0),
                                                       TrackedSmall('a'));
  g_counters.Reset();
...
TEST_F(SortedTupleMoveTest, GetLvalueNoCopyMove) {
  Of<SizeofLess>::Tuple<TrackedLarge, TrackedSmall> t(TrackedLarge(1.0),
                                                      TrackedSmall('a'));
  g_counters.Reset();
...
TEST_F(SortedTupleMoveTest, SwapCounting) {
  Of<SizeofLess>::Tuple<TrackedLarge, TrackedSmall> t1(TrackedLarge(1.0),
                                                       TrackedSmall('a'));
  Of<SizeofLess>::Tuple<TrackedLarge, TrackedSmall> t2(TrackedLarge(2.0),
                                                       TrackedSmall('b'));
  g_counters.Reset();
